...
/**
 * /api/v1/characters/ METHOD: GET - Get all characters
 * /api/v1/characters/ METHOD: POST - Create a character
 * /api/v1/characters/:id METHOD: GET - Get character by id
 * /api/v1/characters/:id METHOD: PUT - Update character by id
 * /api/v1/characters/:id METHOD: PATCH - Update character by id
 * /api/v1/characters/:id/activate METHOD: PUT - Change character status to "active" by id
 * /api/v1/characters/:id/activate METHOD: PATCH - Change character status to "active" by id
 */
...
router.route('/data').get(controller.getCharacterData);
